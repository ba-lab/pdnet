...
File: Contains the code to predict distances
'''
...
model = deepcon_rdd_distances(OUTL, 128, 64, expected_n_channels)
...
save_dist_to_contacts_rr(seq, P[0, :len(seq), :len(seq)], rr)
